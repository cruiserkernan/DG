...
Shaders myShaders("../lab3-4_vs.glsl", "../lab3-4_fs.glsl", "../lab3-4_tc.glsl", "../lab3-4_te.glsl");
...
int main(int argc, char const *argv[])
{
	...
	glGenTextures(1, &texture_height_map_handle);
	...
	checkShaderCompileError(myShaders.getTES());
	checkShaderCompileError(myShaders.getTCS());
	float n = 0.01;
	float f = 100.0;
